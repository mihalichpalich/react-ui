  ...
  return (
    <section className="filter-list">
      <Filter
        ...
        selected={selectedFilter === 'noir'} //сравниванием значение выбранного фильтра с названием
      ...
      <Filter
        name="aged"
        settings={{contrast: 94, hue: -54, brightness: 122, saturate: 0, sepia: 0}}
      ...
      <Filter
        name="whiteout"
        settings={{contrast: 32, hue: 0, brightness: 173, saturate: 100, sepia: 44}}
        selected={selectedFilter === 'aged'}
        onClick={updateSettings}>
        <Image src={image} />
      </Filter>
